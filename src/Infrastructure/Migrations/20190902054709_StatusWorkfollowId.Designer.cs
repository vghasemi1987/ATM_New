...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20190902054709_StatusWorkfollowId")]
    partial class StatusWorkfollowId
    {
            ...
            modelBuilder.Entity("DomainEntities.ApplicationUserAggregate.ApplicationRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            PanelMenu = "[{\"Text\":\"خانه\",\"Link\":\"/home\",\"Icon\":\"flaticon-line-graph\",\"Items\":null},{\"Text\":\"لیست تراکنش ها\",\"Link\":\"/transactiondetails\",\"Icon\":\"fas fa-sitemap\",\"Items\":null},{\"Text\":\"گزارشات\",\"Link\":\"/reports\",\"Icon\":\"flaticon-diagram\",\"Items\":null}]"
                        },
                        new
                        {
                            Id = 5,
                            ...
                            PanelMenu = "[{\"Text\":\"خانه\",\"Link\":\"/home\",\"Icon\":\"flaticon-line-graph\",\"Items\":null},{\"Text\":\"فایل تراکنش ها\",\"Link\":\"/transactions\",\"Icon\":\"flaticon-signs-2\",\"Items\":null},{\"Text\":\"گزارشات\",\"Link\":\"/reports\",\"Icon\":\"flaticon-diagram\",\"Items\":null}]"
                        });
                });
            ...
            modelBuilder.Entity("DomainEntities.ApplicationUserAggregate.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RegDateTime = new DateTime(2019, 9, 2, 9, 17, 6, 719, DateTimeKind.Local).AddTicks(7639),
                        ...
                        new
                        {
                            ...
                            PhoneNumberConfirmed = false,
                            RegDateTime = new DateTime(2019, 9, 2, 9, 17, 6, 723, DateTimeKind.Local).AddTicks(4944),
